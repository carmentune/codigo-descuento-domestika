# Código de Descuento Domestika 10% Extra (Actualizado 2026)
...
1. Explora el catálogo y añade a tu carrito los cursos que desees realizar.

2. Inicia sesión en tu cuenta o regístrate si eres un usuario nuevo.

3. Dirígete a la pasarela de pago (checkout).
...
## Consideraciones sobre los precios reducidos

En ocasiones, la plataforma ofrece cursos a precios muy bajos (por ejemplo, a 0,99€). Si vas a aprovechar estas ofertas junto con tu código, ten en cuenta este detalle fundamental:
